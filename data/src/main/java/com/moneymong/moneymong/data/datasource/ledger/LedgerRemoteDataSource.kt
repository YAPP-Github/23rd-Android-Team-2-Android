...
interface LedgerRemoteDataSource {
    ...
    suspend fun postLedgerReceiptTransaction(body: LedgerReceiptRequest): Result<Unit>
    suspend fun postLedgerDocumentTransaction(body: LedgerDocumentRequest): Result<Unit>
